	...
	<div class="wrap">
		<div class="content-top" style="min-height:300px;padding:50px">
			<div class="col-md-4 col-md-offset-4">
                ...
                <input name="name" type="text" size="25" placeholder="Nom" class="form-control"/>
              ...
              <div class="form-group has-feedback">
                <input name="phone" type="text" size="25" placeholder="Numero de téléphone" class="form-control"/>
              ...
              <div class="form-group has-feedback">
                <input name="password" type="password" size="25" placeholder="Mot de passe" class="form-control" placeholder="Password" />
              ...
              <div class="form-group has-feedback">
                <input name="cpassword" type="password" size="25" placeholder="Confirmation du mot de passe" class="form-control" placeholder="Password" />
